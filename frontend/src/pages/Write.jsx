        ...
        <div className="min-h-screen bg-white font-serif ">
            ...
            <nav className="flex justify-between h-16 items-center px-4 md:px-10 py-2  w-full bg-white z-50">
                ...
                <div className="flex items-center space-x-4 md:space-x-6">
                    <button className="bg-[#1a8917] hover:bg-[#156d12] text-white px-3 py-1 rounded-full text-sm font-medium transition-all cursor-pointer">
                        Publish
                    </button>
                        ...
                        <div className="absolute -left-16 top-3 flex items-center gap-3 transition-all duration-300">
                            ...
                            {showTitleMenu && (
                                <div className="flex items-center gap-2.5 ml-2 animate-fadeInLeft">
                                    <button className="w-9 h-9 border border-[#1a8917] rounded-full flex items-center justify-center text-[#1a8917] hover:bg-green-50 transition-all group/icon" title="Add an image">
